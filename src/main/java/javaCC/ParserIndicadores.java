...
public class ParserIndicadores implements ParserIndicadoresConstants {
    public static void main(String[] args) {
        try {
            //new ParserIndicadores(new java.io.StringReader(args[0])).S();
        	new ParserIndicadores(new java.io.StringReader("a = 2 + 3")).S();
